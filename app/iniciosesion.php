...
if(!empty($_POST['correo']) && !empty($_POST['contrasena'])){
    $consulta = $conexion->prepare('SELECT id, correo, password FROM usuarios WHERE correo=:correo');
               ...
               <div class="row">
                  ...
                  <div class="col-md-6">
                     <div class="contact_box">
                        ...
                        <div class="send_bt"><a href="#">Ingresar</a></div>
